function ls_fϕ(PG::Union{<:ObstacleProblem{T},<:AdaptiveObstacleProblem{T}, <:ObstacleProblem2D{T}, <:BCsObstacleProblem2D{T}, GradientBounds2D{T}}, u::AbstractVector{T}, ψ::AbstractVector{T}, w::AbstractVector{T}, α::T, du::AbstractVector{T}, dψ::AbstractVector{T}, ls_α::T) where T
...
function ls_fdϕ(PG::Union{<:ObstacleProblem2D{T},<:BCsObstacleProblem2D{T}, GradientBounds2D{T}}, u::AbstractVector{T}, ψ::AbstractVector{T}, w::AbstractVector{T}, α::T, du::AbstractVector{T}, dψ::AbstractVector{T}, ls_α::T) where T
    res_u, res_ψ = matrixfree_residual(PG, u+ls_α*du, ψ+ls_α*dψ, w, α)
    A, B = PG.A, PG.B
    dot([res_u;res_ψ], [α*A*du + B*dψ;-B'*du + apply_D(PG,dψ,ψ)]) / LinearAlgebra.norm([res_u;res_ψ])
end
...
function pg_linesearch(PG::Union{<:ObstacleProblem{T},<:AdaptiveObstacleProblem{T}, <:ObstacleProblem2D{T}, <:BCsObstacleProblem2D{T}, GradientBounds2D{T}}, ls::BackTracking{T, Int64}, u::AbstractVector{T}, ψ::AbstractVector{T}, w::AbstractVector{T}, α::T, du::AbstractVector{T}, dψ::AbstractVector{T}) where T
